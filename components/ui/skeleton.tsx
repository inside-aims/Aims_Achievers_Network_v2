...
export function EventDetailsSkeleton() {
  return (
    <div className="rounded-xl border border-primary/15 bg-card overflow-hidden shadow-sm divide-y divide-dashed divide-primary/10">
      {Array.from({ length: 3 }).map((_, i) => (
        <div key={i} className="px-4 md:px-6 py-4 space-y-3">
