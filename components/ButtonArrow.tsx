        ...
        >
          <div className="absolute left-0 flex h-7 w-14 -translate-x-1/2 items-center justify-center transition-all duration-200 ease-in-out group-hover:translate-x-0">
            ...
            <ArrowRight
              size={16}
              className={cn(
                "size-7 p-1 text-orange-600 opacity-0 group-hover:opacity-100"
              )}
            />
            ...
            <ArrowRight
              size={16}
              className={cn(
                "size-7 p-1 text-amber-100 opacity-100 transition-transform duration-300 ease-in-out group-hover:opacity-0"
              )}
            />
          </div>
        </div>
