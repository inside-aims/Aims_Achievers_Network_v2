...
export function DownloadButtons({
  ...
  return (
    ...
    >
      ...
      >
        <Image
          src="/assets/images/app-store-mobile.png"
        ...
        />
        <Image
          src="/assets/images/app-store-mobile-dark.png"
          alt="Download on the App Store"
          width={160}
          height={53}
      ...
      >
        <Image
          src="/assets/images/play-store-light.png"
        ...
        />
        <Image
          src="/assets/images/play-store-dark.png"
          alt="Get it on Google Play"
          width={160}
          height={53}
          className="hidden h-11 w-auto dark:block"
