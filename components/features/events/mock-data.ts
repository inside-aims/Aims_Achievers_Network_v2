import { EventCategory, EventCardProps, NomineeProps } from "./index";

const createNominees = (
  prefix: string,
  names: string[]
): NomineeProps[] => names.map((name, index) => ({
...
export const FAST_CATEGORIES: EventCategory[] = [
  {
...
export const FOE_CATEGORIES: EventCategory[] = [
  {
    id: "foe-student-year",
...
export const FBNE_CATEGORIES: EventCategory[] = [
  {
    id: "foe-student-year",
    name: "FOE Student of the Year",
    description: "Overall best engineering student.",
...
export const FBMS_CATEGORIES: EventCategory[] = [
  {
    id: "foe-student-year",
    name: "FOE Student of the Year",
    description: "Overall best engineering student.",
