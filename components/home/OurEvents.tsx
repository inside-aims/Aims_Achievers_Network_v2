  ...
  return (
    <section className="bg-background text-foreground font-serif py-10 sm:py-20 md:py-24 lg:py-28 px-4 sm:px-6 md:px-8 lg:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Filter Tabs */}
        {/* <div className="flex flex-wrap gap-3 sm:gap-4 mb-10 sm:mb-12 md:mb-14 lg:mb-16 border-b border-border pb-4 sm:pb-5 md:pb-6">
          <button
            onClick={() => setFilter("all")}
            className={`px-4 sm:px-6 md:px-8 py-2 sm:py-2.5 md:py-3 font-light tracking-wide transition-all duration-300 text-sm sm:text-base md:text-lg rounded-t-lg ${
              filter === "all"
        ...
        {/* {filteredEvents.length === 0 && (
          <div className="text-center py-16 sm:py-20 md:py-24">
            <div className="text-muted-foreground/20 mb-6">
              <svg className="w-20 h-20 sm:w-24 sm:h-24 mx-auto" fill="currentColor" viewBox="0 0 20 20">
